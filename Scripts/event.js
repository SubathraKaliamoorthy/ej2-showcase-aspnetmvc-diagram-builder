var DiagramClientSideEvents = (function () {
        ...
        if (args.state === 'Changed') {
            if (selectedItem.diagramType === 'MindMap') {
                ...
                if (selectedItems.length > 1) {
                    DiagramClientSideEvents.prototype.multipleSelectionSettings(selectedItems);
                }
                else if (selectedItems.length === 1) {
                    DiagramClientSideEvents.prototype.singleSelectionSettings(selectedItems[0]);
                }
                else {
    ...
    DiagramClientSideEvents.prototype.nodePositionChange = function (args) {
        ...
        document.getElementById('nodeOffsetX').ej2_instances[0].value = (Math.round(args.newValue.offsetX * 100) / 100);
        document.getElementById('nodeOffsetY').ej2_instances[0].value = (Math.round(args.newValue.offsetY * 100) / 100);
    ...
    DiagramClientSideEvents.prototype.nodeSizeChange = function (args) {
        ...
        document.getElementById('nodeHeight').ej2_instances[0].value = (Math.round(args.newValue.height * 100) / 100);
        if (args.state === 'Completed') {
            selectedItem.isModified = true;
            selectedItem.preventPropertyChange = false;
        }
    ...
    DiagramClientSideEvents.prototype.nodeRotationChange = function (args) {
        selectedItem.preventPropertyChange = true;
        document.getElementById('nodeRotateAngle').ej2_instances[0].value = (Math.round(args.newValue.rotateAngle * 100) / 100);
        selectedItem.preventPropertyChange = false;
        if (args.state === 'Completed') {
            selectedItem.isModified = true;
        }
...
var DiagramPropertyBinding = (function () {
    ...
    DiagramPropertyBinding.prototype.pageBreaksChange = function (args) {
        if (args.event) {
            document.getElementById('showPageBreaks').ej2_instances[0] = args.checked;
    ...
    DiagramPropertyBinding.prototype.multiplePage = function (args) {
        if (args.event) {
            document.getElementById('printMultiplePage').ej2_instances[0] = args.checked;
        }
    };
    DiagramPropertyBinding.prototype.paperListChange = function (args) {
        if (args.element) {
            ...
            document.getElementById("pageSettingsList").ej2_instances[0] = args.value;
            var paperSize = selectedItem.utilityMethods.getPaperSize(document.getElementById("pageSettingsList").ej2_instances[0]);
    ...
    DiagramPropertyBinding.prototype.textPositionChange = function (args) {
        if (args.value !== null) {
            DiagramPropertyBinding.prototype.textPropertyChange('textPosition', args.value);
        }
    };
    DiagramPropertyBinding.prototype.toolbarTextStyleChange = function (args) {
        DiagramPropertyBinding.prototype.textPropertyChange(args.item.tooltipText, false);
    };
    DiagramPropertyBinding.prototype.toolbarTextSubAlignChange = function (args) {
        var propertyName = args.item.tooltipText.replace(/[' ']/g, '');
        DiagramPropertyBinding.prototype.textPropertyChange(propertyName, propertyName);
    };
                        ...
                        if (node.annotations.length > 0) {
                            for (var j = 0; j < node.annotations.length; j++) {
                                ...
                                if (propertyName === 'left' || propertyName === 'right' || propertyName === 'center') {
                                    ...
                                    DiagramPropertyBinding.prototype.updateTextProperties(propertyName, propertyValue, annotation.style);
                                }
                            }
                        }
                        else if (node.shape && node.shape.type === 'Text') {
                            DiagramPropertyBinding.prototype.updateTextProperties(propertyName, propertyValue, node.style);
                        }
                    }
                }
                diagram.dataBind();
    ...
    DiagramPropertyBinding.prototype.updateTextProperties = function (propertyName, propertyValue, annotation) {
        switch (propertyName) {
            case 'bold':
                ...
                DiagramPropertyBinding.prototype.updateToolbarState('toolbarTextStyle', annotation.bold, 0);
                break;
            case 'italic':
                annotation.italic = !annotation.italic;
                DiagramPropertyBinding.prototype.updateToolbarState('toolbarTextStyle', annotation.italic, 1);
                break;
            case 'underline':
                ...
                DiagramPropertyBinding.prototype.updateToolbarState('toolbarTextStyle', selectedItem.textProperties.textDecoration, 2);
                break;
            case 'aligntextleft':
            case 'aligntextright':
...
var MindMapPropertyBinding = (function () {
    ...
    MindMapPropertyBinding.prototype.mindmapTextStyleChange = function (args) {
        MindMapPropertyBinding.prototype.updateMindMapTextStyle(args.item.tooltipText.toLowerCase(), false);
    };
