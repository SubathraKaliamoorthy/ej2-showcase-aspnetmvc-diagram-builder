...
var UtilityMethods = (function () {
    ...
    UtilityMethods.prototype.bindNodeProperties = function (node, selectedItem) {
        ...
        document.getElementById('nodeOffsetX').ej2_instances[0].value = (Math.round(node.offsetX * 100) / 100);
        document.getElementById('nodeOffsetY').ej2_instances[0].value = (Math.round(node.offsetY * 100) / 100);
        document.getElementById('nodeWidth').ej2_instances[0].value = node.width ? (Math.round(node.width * 100) / 100) : (Math.round(node.minWidth * 100) / 100);
        document.getElementById('nodeHeight').ej2_instances[0].value = node.height ? (Math.round(node.height * 100) / 100) : (Math.round(node.minHeight * 100) / 100);
        document.getElementById('nodeRotateAngle').ej2_instances[0].value = node.rotateAngle;
        document.getElementById('nodeStrokeColor').ej2_instances[0].value = this.getHexColor(node.style.strokeColor);
        document.getElementById('nodeBorderStyle').ej2_instances[0].value = node.style.strokeDashArray ? node.style.strokeDashArray : 'None';
    ...
    UtilityMethods.prototype.bindMindMapProperties = function (node, selectedItem) {
        selectedItem.preventPropertyChange = true;
        document.getElementById('mindmapStroke').ej2_instances[0].value = node.style.strokeColor;
        document.getElementById('strokeStyle').ej2_instances[0].value = node.style.strokeDashArray ? node.style.strokeDashArray : 'None';
        document.getElementById('mindmapStrokeWidth').ej2_instances[0].value = node.style.strokeWidth;
        document.getElementById('mindmapFill').ej2_instances[0].value = node.style.fill;
        document.getElementById('mindmapOpacitySlider').ej2_instances[0].value = (node.style.opacity || 1) * 100;
        if (node.annotations.length > 0) {
            var annotation = node.annotations[0].style;
            document.getElementById('mindmapFontFamilyList').ej2_instances[0].value = annotation.fontFamily;
            document.getElementById('mindmapTextColor').ej2_instances[0].value = annotation.color;
            document.getElementById('mindmapFontSize').ej2_instances[0].value = annotation.fontSize;
            document.getElementById('mindmapTextOpacitySlider').ej2_instances[0].value = (annotation.opacity || 1) * 100;
        }
        selectedItem.preventPropertyChange = false;
    };
    UtilityMethods.prototype.bindTextProperties = function (text, selectedItem) {
        selectedItem.preventPropertyChange = true;
        document.getElementById('textColor').ej2_instances[0].value = this.getHexColor(text.color);
    ...
    UtilityMethods.prototype.bindConnectorProperties = function (connector, selectedItem) {
        selectedItem.preventPropertyChange = true;
        document.getElementById('lineColor').ej2_instances[0].value = this.getHexColor(connector.style.strokeColor);
        document.getElementById('lineStyle').ej2_instances[0].value = connector.style.strokeDashArray ? connector.style.strokeDashArray : 'None';
        document.getElementById('lineTypeDropdown').ej2_instances[0].value = connector.type;
        document.getElementById('lineWidth').ej2_instances[0].value = connector.style.strokeWidth;
        ...
        document.getElementById('sourceSize').ej2_instances[0].value = connector.sourceDecorator.width;
        selectedItem.preventPropertyChange = false;
    };
    ...
    UtilityMethods.prototype.undoRedoLayout = function (isundo, selectedItem) {
        ...
        if (diagram.selectedItems.nodes.length === 0) {
            UtilityMethods.prototype.updateSectionforNode(selectedItem);
        }
        diagram.doLayout();
        selectedItem.isModified = true;
    };
