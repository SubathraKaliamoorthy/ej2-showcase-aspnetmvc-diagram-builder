var ElectricalShapes = (function () {
    ...
    ElectricalShapes.prototype.getElectricalAudioShapes = function () {
        ...
        for (var i = 0; i < audioShapes.length; i++) {
            if (!audioShapes[i].children) {
                audioShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalCapcitorsShapes = function () {
        ...
        for (var i = 0; i < capacitorsShapes.length; i++) {
            if (!capacitorsShapes[i].children) {
                capacitorsShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalDiodesShapes = function () {
        ...
        for (var i = 0; i < diodeShapes.length; i++) {
            if (!diodeShapes[i].children) {
                diodeShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalGatesShapes = function () {
        ...
        for (var i = 0; i < gateShapes.length; i++) {
            if (!gateShapes[i].children) {
                gateShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalInductorsShapes = function () {
        ...
        for (var i = 0; i < inductorsShapes.length; i++) {
            if (!inductorsShapes[i].children) {
                inductorsShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalInstrumentsShapes = function () {
        ...
        for (var i = 0; i < instrumentShapes.length; i++) {
            if (!instrumentShapes[i].children) {
                instrumentShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalMiscShapes = function () {
        ...
        for (var i = 0; i < miscShapes.length; i++) {
            if (!miscShapes[i].children) {
                miscShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalOpticalShapes = function () {
        ...
        for (var i = 0; i < opticalShapes.length; i++) {
            if (!opticalShapes[i].children) {
                opticalShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalLadderShapes = function () {
        ...
        for (var i = 0; i < ladderShapes.length; i++) {
            if (!ladderShapes[i].children) {
                ladderShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalResistorShapes = function () {
        ...
        for (var i = 0; i < resistorShapes.length; i++) {
            if (!resistorShapes[i].children) {
                resistorShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalEquipmentShapes = function () {
        ...
        for (var i = 0; i < equipmentShapes.length; i++) {
            if (!equipmentShapes[i].children) {
                equipmentShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalSourcesShapes = function () {
        ...
        for (var i = 0; i < sourcesShapes.length; i++) {
            if (!sourcesShapes[i].children) {
                sourcesShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalSwitchesShapes = function () {
        ...
        for (var i = 0; i < switchesShapes.length; i++) {
            if (!switchesShapes[i].children) {
                switchesShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalTransmissionShapes = function () {
        ...
        for (var i = 0; i < transmissionShapes.length; i++) {
            if (!transmissionShapes[i].children) {
                transmissionShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalTransistorsShapes = function () {
        ...
        for (var i = 0; i < transistorsShapes.length; i++) {
            if (!transistorsShapes[i].children) {
                transistorsShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalVaccumShapes = function () {
        ...
        for (var i = 0; i < vaccumShapes.length; i++) {
            if (!vaccumShapes[i].children) {
                vaccumShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
    ...
    ElectricalShapes.prototype.getElectricalWaveformsShapes = function () {
        ...
        for (var i = 0; i < WaveformsShapes.length; i++) {
            if (!WaveformsShapes[i].children) {
                WaveformsShapes[i].constraints = ej.diagrams.NodeConstraints.Default & ~ej.diagrams.NodeConstraints.Select;
            }
